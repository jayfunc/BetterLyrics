    ...
    )
    {
        ...
        for (var i = safeStart; i <= safeEnd; i++)
        {
            ...
            if (!autoWrap)
            {
                ...
                var pSize = isVertical
                    ? line.PrimaryTextLayoutBounds.Height
                    : line.PrimaryTextLayoutBounds.Width;
                var sSize = isVertical
                    ? line.SecondaryTextLayoutBounds.Height
                    : line.SecondaryTextLayoutBounds.Width;
                var tSize = isVertical
                    ? line.TertiaryTextLayoutBounds.Height
                    : line.TertiaryTextLayoutBounds.Width;
