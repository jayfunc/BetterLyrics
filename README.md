...
To solve this issue, please try to download from [Google Drive (v1.0.83.0)](https://drive.google.com/file/d/1-qV1ast1Im0EveG7jVGI9Y3quLVj2EyB/view?usp=sharing) (may not be the latest version) and follow the instructions [here](https://github.com/jayfunc/BetterLyrics/blob/dev/How2Install/How2Install.md).
