...
<div align="center">
  ...
  <p>
    一款优雅且高度自定义的歌词可视化与全能音乐播放应用，<br>基于 WinUI 3 & Win2D 构建
  </p>

  <p>
    <a href="https://github.com/jayfunc/BetterLyrics/stargazers"><img src="https://img.shields.io/github/stars/jayfunc/BetterLyrics?label=%E6%98%9F%E6%A0%87" alt="Stars"></a>
    <a href="https://github.com/jayfunc/BetterLyrics/releases/latest"><img src="https://img.shields.io/github/downloads/jayfunc/BetterLyrics/total?label=%E4%B8%8B%E8%BD%BD%E9%87%8F" alt="Downloads"></a>
    <img src="https://img.shields.io/badge/%E8%AF%AD%E8%A8%80-C%23-purple" alt="C#">
    <img src="https://img.shields.io/badge/%E6%A1%86%E6%9E%B6-WinUI_3-blue" alt="WinUI 3">
    <a href="https://github.com/jayfunc/BetterLyrics/blob/main/LICENSE"><img src="https://img.shields.io/badge/%E8%AE%B8%E5%8F%AF%E8%AF%81-GPL_v3.0-blue" alt="License"></a>
  </p>

  <p>
    <a href="https://betterlyrics.github.io/zh-cn"><img alt="Official Website" src="https://img.shields.io/github/actions/workflow/status/BetterLyrics/BetterLyrics.github.io/pages%2Fpages-build-deployment?label=%E5%AE%98%E7%BD%91"></a>
    <a href="https://crowdin.com/project/betterlyrics"><img src="https://badges.crowdin.net/betterlyrics/localized.svg" alt="Crowdin"></a>
    <a href="https://luizvbo.github.io/kstars/pages/language.html?lang=CSharp"><img src="https://img.shields.io/badge/GitHub_%E6%8E%92%E5%90%8D-C%23_%E5%89%8D_1000-purple" alt="GitHub C# Top 1000"></a>
  </p>
...
### 惊艳视觉与灵动歌词
- **流畅界面：** 基于 WinUI 3 与 Win2D 打造的现代交互体验，拥有丝滑的动画效果、高度可定制的播放控制栏与深度定制选项。
- **高阶歌词动效：** 让每一个字符随音乐律动。包含**逐音节高亮**、**长音余韵发光**以及远端歌词的**透视淡出**效果。
- **交互式布局编辑器：** 全功能的拖拽式布局编辑器，可自由调整歌词、专辑封面和播放控制栏的位置与大小，设计出你心中完美的播放器布局。
- **全方位视觉掌控：** 除去预设方案，你还可以微调歌词动画、字体、主题色提取及各类视觉行为，打造专属你的独特风格。
- **变色龙自适应主题：** 智能主题引擎能动态对屏幕边缘环境或专辑封面进行颜色采样，让播放器 UI 完美融入你的桌面。
...
- **广泛的外部集成：** 适配并可视化来自 Spotify、Apple Music、网易云音乐及 [众多主流播放器](https://betterlyrics.github.io/zh-cn/docs/player-cfg/intro.html) 的音频。
...
- **数据统计与“年度报告”故事模式：** 精美的统计中心带你回顾听歌历史，并包含沉浸式的视觉故事模式，揭示你的年度最爱歌手、听歌人设以及特殊时刻。
...
| :---: | :---: |
| <a href="https://apps.microsoft.com/detail/9P1WCD1P597R?referrer=appbadge&mode=direct"><img src="https://get.microsoft.com/images/en-us%20dark.svg" width="160" alt="Get it from Microsoft"/></a><br>无限期免费试用（功能与付费版一致） | [**最新版本 (.zip)**](https://github.com/jayfunc/BetterLyrics/releases/latest)<br>[查看安装指南](https://betterlyrics.github.io/zh-cn/docs/get-started/install.html) |

**[使用文档](https://betterlyrics.github.io/zh-cn/docs/get-started/welcome.html) | [插件商店](https://betterlyrics.github.io/zh-cn/docs/add-ons/plugins-store.html) | [隐私政策](docs/PRIVACY_POLICY.CN.md) | [服务条款](docs/TERMS_OF_SERVICE.CN.md)**
...
<details>
<summary><b>点击此处查看所有样式</b></summary>
<br>
...
| 网页平台 | 支付宝 / 微信支付 |
| :---: | :---: |
| [PayPal](https://paypal.me/zhefangpay)<br><br>[Buy Me a Coffee](https://buymeacoffee.com/founchoo)<br><br>[爱发电 (Afdian)](https://afdian.com/a/jayfunc) | <img src="docs/assets/donation/alipay_wechatpay.png" height="240" alt="Alipay and WeChat Pay QR Codes"> |

**[查看完整的赞助者名单 (Hall of Fame)](docs/SPONSORS.md)**
