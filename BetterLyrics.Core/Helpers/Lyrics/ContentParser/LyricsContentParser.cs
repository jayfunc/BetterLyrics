...
namespace BetterLyrics.Core.Helpers.Lyrics.ContentParser
{
    public partial class LyricsContentParser
    {
        ...
        private static readonly ISystemUIProvider _systemUIProvider = Ioc.Default.GetRequiredService<ISystemUIProvider>();
        ...
        )
        {
            ...
            else if (settings.IsJapaneseRomanizationEnabled && main.LanguageCode == LanguageHelper.JapaneseCode)
            {
                ...
                else
                {
                    ...
                    {
                        _systemUIProvider.ShowToast("Error", ex.Message, MessageSeverity.Error);
                    }
                }
            }
            ...
            if (settings.IsTranslationEnabled && main.LanguageCode != settings.SelectedTargetLanguageCode)
            {
                ...
                else if (settings.IsLibreTranslateEnabled)
                {
                    ...
                    {
                        _systemUIProvider.ShowToast("LibreTranslateFailed", ex.Message, MessageSeverity.Error);
                    }
                }
            }
