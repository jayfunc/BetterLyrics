...
namespace BetterLyrics.Core.Models.Settings
{
    ...
    {
        private readonly ISystemUIProvider _systemUIProvider = Ioc.Default.GetRequiredService<ISystemUIProvider>();
        ...
        [ObservableProperty][NotifyPropertyChangedRecipients][NotifyPropertyChangedFor(nameof(DemoWindowMargin))] public partial AppRect WindowBounds { get; set; } = new AppRect(100, 100, 800, 500);
        [ObservableProperty][NotifyPropertyChangedRecipients] public partial double DockHeight { get; set; } = 64;
        [ObservableProperty][NotifyPropertyChangedFor(nameof(DemoWindowMargin))] public partial AppRect MonitorBounds { get; set; }
        ...
        [ObservableProperty][NotifyPropertyChangedRecipients] public partial AppTheme WindowTheme { get; set; } = AppTheme.Dark;
        ...
        [JsonIgnore] public AppThickness DemoWindowMargin => new(WindowBounds.Left - MonitorBounds.Left, WindowBounds.Top - MonitorBounds.Top, 0, 0);
        ...
        public LyricsWindowStatus()
        {
            ...
            (MonitorDeviceName, MonitorBounds) = _systemUIProvider.GetPrimaryMonitorInfo();
        }
