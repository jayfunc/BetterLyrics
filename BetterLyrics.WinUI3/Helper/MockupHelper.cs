...
namespace BetterLyrics.WinUI3.Helper
{
    ...
    {
        public static FrameworkElement GenerateMockupContent(FrameworkElement frameworkElement, ComponentType type, HorizontalAlignment align, string displayName)
        {
            ...
            switch (type)
            {
                ...
                case ComponentType.Lyrics:
                    var lyricsStack = new StackPanel { Spacing = 12, HorizontalAlignment = HorizontalAlignment.Center, Width = 500 };
