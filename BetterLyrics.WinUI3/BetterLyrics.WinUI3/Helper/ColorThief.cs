...
namespace BetterLyrics.WinUI3.Helper
{
    ...
    /// <summary>
    /// Defines the <see cref="ColorThief" />
    /// </summary>
    public class ColorThief
    {
        ...
        /// <summary>
        /// Defines the ColorDepth
        /// </summary>
        public const int ColorDepth = 4;

        /// <summary>
        /// Defines the DefaultColorCount
        /// </summary>
        public const int DefaultColorCount = 5;

        /// <summary>
        /// Defines the DefaultIgnoreWhite
        /// </summary>
        public const bool DefaultIgnoreWhite = true;

        /// <summary>
        /// Defines the DefaultQuality
        /// </summary>
        ...
        /// <param name="quality">The quality<see cref="int"/></param>
        ...
        /// <param name="pixelCount">The pixelCount<see cref="int"/></param>
        /// <param name="quality">The quality<see cref="int"/></param>
        /// <param name="ignoreWhite">The ignoreWhite<see cref="bool"/></param>
        ...
        /// The GetColorMap
        /// </summary>
        /// <param name="pixelArray">The pixelArray<see cref="byte[][]"/></param>
        /// <param name="colorCount">The colorCount<see cref="int"/></param>
        /// <returns>The <see cref="CMap"/></returns>
        ...
        /// The GetIntFromPixel
        /// </summary>
        /// <param name="decoder">The decoder<see cref="BitmapDecoder"/></param>
        ...
        /// The GetPixelsFast
        /// </summary>
        /// <param name="sourceImage">The sourceImage<see cref="BitmapDecoder"/></param>
        /// <param name="quality">The quality<see cref="int"/></param>
        /// <param name="ignoreWhite">The ignoreWhite<see cref="bool"/></param>
        /// <returns>The <see cref="Task{byte[][]}"/></returns>
    ...
    /// <summary>
    /// Defines the <see cref="QuantizedColor" />
    /// </summary>
    public class QuantizedColor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QuantizedColor"/> class.
        /// </summary>
        /// <param name="color">The color<see cref="RGB"/></param>
        /// <param name="population">The population<see cref="int"/></param>
        ...
        /// <summary>
        /// Gets a value indicating whether IsDark
        /// </summary>
    ...
    internal class CMap
    {
        ...
        /// The FindColor
        /// </summary>
        /// <param name="targetLuma">The targetLuma<see cref="double"/></param>
        /// <param name="minLuma">The minLuma<see cref="double"/></param>
        /// <param name="maxLuma">The maxLuma<see cref="double"/></param>
        /// <param name="targetSaturation">The targetSaturation<see cref="double"/></param>
        /// <param name="minSaturation">The minSaturation<see cref="double"/></param>
        /// <param name="maxSaturation">The maxSaturation<see cref="double"/></param>
        /// <returns>The <see cref="VBox"/></returns>
        ...
        /// The GeneratePalette
        /// </summary>
        /// <returns>The <see cref="List{QuantizedColor}"/></returns>
        ...
        /// The Push
        /// </summary>
        /// <param name="box">The box<see cref="VBox"/></param>
    ...
    internal static class Mmcq
    {
        ...
        /// <summary>
        /// The CreateComparisonValue
        /// </summary>
        /// <param name="saturation">The saturation<see cref="double"/></param>
        /// <param name="targetSaturation">The targetSaturation<see cref="double"/></param>
        /// <param name="luma">The luma<see cref="double"/></param>
        /// <param name="targetLuma">The targetLuma<see cref="double"/></param>
        /// <param name="population">The population<see cref="int"/></param>
        /// <param name="highestPopulation">The highestPopulation<see cref="int"/></param>
        ...
        /// </summary>
        /// <param name="pixels">The pixels<see cref="byte[][]"/></param>
        /// <param name="maxcolors">The maxcolors<see cref="int"/></param>
        /// <returns>The <see cref="CMap"/></returns>
        ...
        /// The DoCut
        /// </summary>
        /// <param name="color">The color<see cref="char"/></param>
        /// <param name="vbox">The vbox<see cref="VBox"/></param>
        /// <param name="partialsum">The partialsum<see cref="IList{int}"/></param>
        /// <param name="lookaheadsum">The lookaheadsum<see cref="IList{int}"/></param>
        ...
        /// <param name="targetValue">The targetValue<see cref="double"/></param>
        /// <returns>The <see cref="double"/></returns>
        ...
        /// The MedianCutApply
        /// </summary>
        /// <param name="histo">The histo<see cref="IList{int}"/></param>
        /// <param name="vbox">The vbox<see cref="VBox"/></param>
        /// <returns>The <see cref="VBox?[]?"/></returns>
        ...
        /// The VboxFromPixels
        /// </summary>
        /// <param name="pixels">The pixels<see cref="IList{byte[]}"/></param>
        /// <param name="histo">The histo<see cref="int[]"/></param>
        /// <returns>The <see cref="VBox"/></returns>
    ...
    internal class VBox
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VBox"/> class.
        /// </summary>
        /// <param name="r1">The r1<see cref="int"/></param>
        /// <param name="r2">The r2<see cref="int"/></param>
        /// <param name="g1">The g1<see cref="int"/></param>
        /// <param name="g2">The g2<see cref="int"/></param>
        /// <param name="b1">The b1<see cref="int"/></param>
        /// <param name="b2">The b2<see cref="int"/></param>
        /// <param name="histo">The histo<see cref="int[]"/></param>
        ...
        /// The Contains
        /// </summary>
        /// <param name="pixel">The pixel<see cref="int[]"/></param>
    ...
    /// <summary>
    /// Defines the <see cref="VBoxComparer" />
    /// </summary>
    internal class VBoxComparer : IComparer<VBox>
    {
        ...
        /// The Compare
        /// </summary>
        /// <param name="x">The x<see cref="VBox"/></param>
        /// <param name="y">The y<see cref="VBox"/></param>
        /// <returns>The <see cref="int"/></returns>
    ...
    /// <summary>
    /// Defines the <see cref="VBoxCountComparer" />
    /// </summary>
