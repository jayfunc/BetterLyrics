...
namespace BetterLyrics.WinUI3.Renderer.LyricsRenderer
{
    public class HorizontalLyricsLineRenderer : LyricsLineRendererBase
    {
        ...
        protected override CanvasLinearGradientBrush CreateGradientBrush(ICanvasResourceCreator resourceCreator, CanvasGradientStop[] stops, Rect bounds)
        {
            // 横排：从左向右渐变
        ...
        {
            // 横排：只裁剪宽度的进度
            return new Rect(sourceCharRect.X, sourceCharRect.Y, sourceCharRect.Width * progressPlayed, sourceCharRect.Height);
        }
